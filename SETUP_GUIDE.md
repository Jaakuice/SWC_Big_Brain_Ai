# Setup Guide: SWC-Ai Knowledge Base

Quick setup instructions for using this knowledge base with Cursor IDE, Claude Code, Codex, and other coding IDEs.
...
*For detailed information about the dataset, see README.md*
