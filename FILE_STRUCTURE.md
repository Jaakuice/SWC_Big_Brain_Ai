...
#### **`/Tweets/asjwebley/`** (23 files: 22 JSON + 1 README)
...
- **Statistics:** 1066 meaningful posts from 1,330+ total timeline items
...
- **File Format:** `posts-YYYY-MM.json`
- **Statistics:** 716 meaningful posts
...
- **File Format:** `posts-YYYY-MM.json`
- **Statistics:** 299 meaningful posts
